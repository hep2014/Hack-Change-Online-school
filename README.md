...
Интерфейс проекта был разработан так, чтобы сочетать в себе анимации и дизайн современных сайтов:

- **Тёмно-зелёная цветовая палитра** на всех страницах сайта
- **Неоновые акценты и вспышки** при наведении на элементы
...
- полностью изолирована от данных.
